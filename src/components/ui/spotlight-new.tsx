...
export const Spotlight = ({
  gradientFirst = 'radial-gradient(68.54% 68.72% at 55.02% 31.46%, hsla(22, 100%, 70%, .12) 0, hsla(22, 100%, 55%, .04) 50%, hsla(22, 100%, 45%, 0) 80%)',
  gradientSecond = 'radial-gradient(50% 50% at 50% 50%, hsla(263, 100%, 75%, .08) 0, hsla(263, 100%, 55%, .03) 80%, transparent 100%)',
  gradientThird = 'radial-gradient(50% 50% at 50% 50%, hsla(22, 100%, 70%, .06) 0, hsla(22, 100%, 45%, .02) 80%, transparent 100%)',
  translateY = -350,
  width = 560,
  height = 1380,
  smallWidth = 240,
